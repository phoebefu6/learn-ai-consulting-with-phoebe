...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    var m = mx || crumb.textContent.match(/Consultant session (\d+) of 10/);
    if (m) {
      var current = parseInt(m[1], 10);
      // This course's own session filenames. Renaming a page means renaming it here.
      var pages = mx
        ? ["a1-the-jagged-frontier.html",
           "a2-the-engagement-repriced.html",
           "a3-the-two-rails.html",
           "a4-quality-at-ai-speed.html",
           "a5-the-firms-ai-operating-model.html",
           "a6-leading-the-transition.html"]
        : ["b1-meet-the-engagement.html",
           "b2-proposal-and-scoping.html",
           "b3-research-that-holds-up.html",
           "b4-analysis-copilot.html",
           "b5-the-storyline.html",
           "b6-the-deck.html",
           "b7-client-communications.html",
           "b8-the-confidentiality-drill.html",
           "b9-qa-and-readout.html",
           "b10-capstone-the-engagement.html"];
